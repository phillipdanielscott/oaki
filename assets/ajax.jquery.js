  ...
  var mt = {
      ...
      if (n) {
        ...
        $.ajax({
          ...
          success: function(i) {
            ...
            eval($(i).filter("#load_products").text());
            mt.hideLoading();
    ...
    doAjaxAddToCart: function(n, r, i, s) {
      ...
      $.ajax({
        ...
        success: function(n) {
          // phillip changes. changed product title to just title to show size
          console.log(n);
          var variantTitle = '<strong>' + n.title + '</strong>';
          console.log("variant is: ", variantTitle);
          $('.alert').html('<div class="cart-message BounceInDown"> <i class="fa fa-check" aria-hidden="true" style="color: green;"></i>    ' + n.title + ' has been added to your cart. <a href="https://oakiwear.myshopify.com/cart" class="button wc-forward">View cart</a></div>');
          mt.hideLoading();
    ...
    goQuickView: function() {
      jQuery(".quickview-button a").click(function() { return;
